...
function Resetpassword() {
  ...
  const handleReset = async (e) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        setError(result.new_password?.[0] || result.detail || "Reset failed.");
      }
    } catch (err) {
      console.error(err);
  ...
  return (
    <div className="min-h-screen flex justify-center items-center px-4 dark:bg-[#101922] bg-white">
      <div className="w-full max-w-md p-6 bg-white dark:bg-black rounded shadow-md border border-gray-800">
