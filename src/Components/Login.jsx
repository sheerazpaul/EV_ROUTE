    ...
    <div className="flex flex-col lg:flex-row items-center justify-center gap-10 lg:gap-[300px] px-4 lg:px-10">
      ...
      <div className="flex flex-col gap-5 mt-10 w-full sm:w-[380px] max-w-[400px]">
        ...
        <div className="text-center sm:text-left">
          ...
          <p className="dark:text-gray-400 text-gray-900">Login to find your next charge</p>
        </div>
        ...
        <div>
          ...
          <div className="mt-5">
            <Button onPress={handleLogin} color="primary" className="w-full font-semibold" radius="sm" size="lg">
              Login
            </Button>
          </div>
