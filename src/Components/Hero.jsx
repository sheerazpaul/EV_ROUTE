...
function Hero() {
  ...
  return (
    <div className="group bg-[url('/images/car-4.jpg')] dark:bg-[url('/images/car-2.jpg')] h-[400px] sm:h-[450px] md:h-[540px] w-full bg-cover bg-center rounded-2xl mx-auto my-5 px-4 flex justify-center items-center overflow-hidden">
